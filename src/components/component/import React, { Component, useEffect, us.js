    ...
    return (
        <div>
            ...
            <div className="wrp-step-box">
                ...
                <div className={(userType == 5 && M_module == 0)?`step-box_hight2 step-box`: userType == 3 || (userType == 5 && M_module == 0)?`step-box_hight step-box`:"step-box"}>
                    <div className="step-trainers-box">
                        <p>{t("SESSIONS")}</p>
                    </div>
                    <div className="main-checkbox">
                        ...
                        {
                            (userType == 5 || userType == 6)?"":<div className="checkbox-wrp">
                            <div class="custom-radios">
                    ...
                    {
                        userType == 3 || (userType == 5 && M_module == 0)?"": <div className="step-smallbox">
