                ...
                <div className="chart-header-c3">
                    <ul className="username-list">
                        {sessioninfo.map((clientName) => {
                            return (
                                <li><a href="javascript:void"><i class="fa fa-user" aria-hidden="true"></i>{clientName.client_firstname}{clientName.client_lastname}</a></li>
                            )
                        }
                        )}
                        {sessioninfo.map((trainerName) => {
                            return (
                                <li><a href="javascript:void"><i class="fa fa-user-md" aria-hidden="true"></i> {trainerName.trainer_firstname} {trainerName.trainer_lastname}</a></li>
                            )
                        }
                        )}
                        ...
                        {sessioninfo.map((sessionName) => {
                            return (
                                <li><a href="javascript:void"><i class="fa fa-calendar" aria-hidden="true"></i> {sessionName.name}</a></li>
                            )
                        }
                        )}
                    </ul>
