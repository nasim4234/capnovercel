...
const Uploadclientform = () => {
    ...
    const submittrainerform = () => {
        ...
        if(userType == 2){
            if (clientSelected.current.value == "" || clientSelected.current.value == "Choose a client" || formname.current.value == "Choose a client" || !formFile.current.files[0]) {
            ...
            if(!formFile.current.files[0] || clientSelected.current.value == "" || trainerSelected.current.value == "" || formname.current.value == "Choose a client"){
                toggleModal()
                return false;
            }
        }
