            ...
            _data.map((v, i) => {
                ...
                if ((v.form_name == currentForm || currentForm == "all") && (v.sessid == selectedSession || selectedSession == "null" || (selectedSession != "null" && currentForm == "all"))) {
                    ...
                    _temp.push({
                        ...
                        }} title="Download" placement="top"><a href="javascript:void(0)" className="downloadimg tooltip2" onClick={() => onButtonClick(FORM_URL + '/trainer_forms/' + v.form)}><img src={download} /> </a></Tooltip> <Tooltip classes={{
                            tooltip: classes.customTooltip,

                        }} title="View" placement="top"><a href="javascript:void(0)" className="downloadimg tooltip2" onClick={() => onButtonClickopen(FORM_URL + '/trainer_forms/' + v.form)}><img src={preveiw} /></a></Tooltip> <Tooltip classes={{
                            tooltip: classes.customTooltip,
            ...
            <div className="wrp-dashbord">
                ...
                <div className="right-section">
                    <div className="wrp-view-uploadclientform">
                        ...
                        <div className="uploadclientformheading"><h3>View Uploaded Trainer Forms</h3></div>
                        ...
                        <div className="row">
                            {
                                ...
                                {
                                    userType == 2?"": <div className="col-lg-3">
