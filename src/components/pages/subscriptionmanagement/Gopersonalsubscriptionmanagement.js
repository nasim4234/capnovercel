...
const Gopersonalsubscriptionmanagement = () => {
                           ...
                           <div className="radio-input"> <input class="form-check-input" name="autorenew" type="radio" defaultChecked={owner.autorenew == 1? true : false} value="1" onChange={() => handleAutorenew(1)} /><span>{t('yes')}</span></div> */}
                            ...
                            <div className="renew-wrp">
                                ...
                                <div className="receive-paragraph">
                                    ...
                                    {
                                        ownerseven?.serial_key &&
                                        <p>Your renewal date for your instrument, serial number <b>{ownerseven?.serial_key ? ownerseven?.serial_key : "NA"}, is {ownerseven?.expires_at ? new Date(ownerseven?.expires_at * 1e3).toLocaleDateString('en-IN', {
                                            day: 'numeric',
                                            month: 'long',
                                            year: 'numeric'
                            ...
                            <ul className="anual-renew-list">
                                ...
                                <li className="goanual-renew-list"><p>Click here to <b><u><a href="/subscription/update/0">UPGRADE</a></u></b> to the C-Option (PC and Apple computers), $300.00.</p></li>
                                <li><p>Click here to <b><u><a href="/subscription/update/1">UPGRADE</a></u></b> to the M-Option (Multiuser), $450.00.</p></li>

                                <li><p>Click here to <b><u><a href="/subscription/update/2">UPGRADE</a></u></b> to the Basic System (includes c and M features), $750.00.</p></li>
                                <li><p>Click here to <b><u><a href="/subscription/update/3">UPGRADE</a></u></b> to the Professional System (includes c and M features), $2,250.00</p></li>
...
export default Gopersonalsubscriptionmanagement;