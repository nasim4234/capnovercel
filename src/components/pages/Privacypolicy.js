...
const Privacypolicy = ()=>{
    ...
    return(
        <div className="container-fluid">
            <div className="wrp-privacypolicy">
                <div className="headingprivacypolicy">
                    <h1>Privacy Policy</h1>
                </div>
                <br></br>
                <p>Updated at 2022-01-03</p>
                <br></br>
                <p> CapnoTrainer (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by CapnoTrainer.</p>
                <br></br>
                <p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”) alongside our application, CapnoTrainer. By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service. This Privacy Policy was created with <a href="https://termify.io" target="_blank">Termify</a>.</p>
                <br></br>
                <div className="headingprivacypolicy">
                ...
                <ul className="listprivacy">
                    ...
                    <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Better Physiology Ltd., 109 East 17th Street, WY 82001 Cheyenne, WY 82001 USA that is responsible for your information under this Privacy Policy.</li>
                    <li>Country: where CapnoTrainer or the owners/founders of CapnoTrainer are based, in this case is United States of America</li>
                    <li>Customer: refers to the company, organization or person that signs up to use the CapnoTrainer Service to manage the relationships with your consumers or service users.</li>
                    <li>Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit CapnoTrainer and use the services.</li>
                    ...
                    <li>Personnel: refers to those individuals who are employed by CapnoTrainer or are under contract to perform a service on behalf of one of the parties.</li>
                    ...
                    <li>Service: refers to the service provided by CapnoTrainer as described in the relative terms (if available) and on this platform.</li>
                    ...
                    <li>Website: CapnoTrainer's site, which can be accessed via this URL: </li>
                    <li>You: a person or entity that is registered with CapnoTrainer to use the Services.</li>
                </ul>
                <br></br>
                <div className="headingprivacypolicy">
                ...
                <br></br>
                <ul className="listprivacy"><li>Name / Username</li><li>Phone Numbers</li><li>Email Addresses</li><li>Age</li>
                </ul>
                <br></br>
                <div className="headingprivacypolicy">
                ...
                <br></br>
                <div className="headingprivacypolicy">
                    <h1>When does CapnoTrainer use end user information from third parties?</h1>

                </div>
                <br></br>
                <p>CapnoTrainer will collect End User Data necessary to provide the CapnoTrainer services to our customers.</p>
                <br></br>
                ...
                <div className="headingprivacypolicy">
                    <h1>When does CapnoTrainer use customer information from third parties?</h1>

                </div>
                <br></br>
                <p>We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a CapnoTrainer customer, we receive information from a third party that provides automated fraud detection services to CapnoTrainer. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.</p>
                <br></br>
                <div className="headingprivacypolicy">
                ...
                <br></br>
                <p>CapnoTrainer will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>
                <br></br>
                <div className="headingprivacypolicy">
                ...
                <br></br>
                <p>The rights you have to request updates or corrections to the information CapnoTrainer collects depend on your relationship with CapnoTrainer. Personnel may update or correct their information as detailed in our internal company employment policies.</p>
                <br></br>
                ...
                <br></br>
                <p>If you are a CapnoTrainer worker or applicant, we collect information you voluntarily provide to us. We use the information collected for Human Resources purposes in order to administer benefits to workers and screen applicants.</p>
                ...
                <br></br>
                <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of CapnoTrainer or any of its Corporate Affiliates (as defined herein), or that portion of CapnoTrainer or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>
                <br></br>
                <div className="headingprivacypolicy">
                    <h1>Affiliates</h1>
                </div>
                <br></br>
                <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, "Corporate Affiliate" means any person or entity which directly or indirectly controls, is controlled by or is under common control with CapnoTrainer, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p>
                <br></br>
                <div className="headingprivacypolicy">
                    <h1>Governing Law</h1>
                </div>
                ...
                <br></br>
                <p>You acknowledge and agree that CapnoTrainer shall not be responsible for any Third-Party Services, including their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other aspect thereof. CapnoTrainer does not assume and shall not have any liability or responsibility to you or any other person or entity for any Third-Party Services.</p>
                <br></br>
                ...
                <br></br>
                <ul className="listprivacy"><li>Via Email:  <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b2c6d7d1daf2d0d7c6c6d7c0c2dacbc1dbdddeddd5cb9cd1dddf">[email&#160;protected]</a></li><li>Via Phone Number:  +1307.773.0888</li><li>Via this Link:  https://betterphysiology.com/</li><li>Via this Address: 109 East 17th Street, WY 82001 Cheyenne, WY 82001 USA</li>
</ul>
            </div>
        </div>
    )
