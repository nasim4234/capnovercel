                    ...
                    resp.data.map((v, i) => {
                        ...
                        if (v.form_name == currentForm || currentForm == "all") {
                            ...
                            _temp.push({
                                ...
                                }} title="Download" placement="top"><a href="javascript:void(0)" className="downloadimg tooltip2" onClick={()=> onButtonClick(FORM_URL + '/client_forms/' + v.form)}><img src={download} /> </a></Tooltip> <Tooltip classes={{
                                    tooltip: classes.customTooltip,

                                }} title="View" placement="top"><a href="javascript:void(0)" className="downloadimg tooltip2" onClick={()=> onButtonClickopen(FORM_URL + '/client_forms/' + v.form)}><img src={preveiw} /></a></Tooltip> <Tooltip classes={{
                                    tooltip: classes.customTooltip,
            ...
            <div className="wrp-dashbord">
                ...
                <div className="right-section">
                    <div className="wrp-view-uploadclientform">
                        ...
                        <div className="uploadclientformheading"><h3>View Completed Client Forms</h3></div>
                    </div>
                        ...
                        <div className="row">
                            {
                                ...
                                {
                                    userType == 2?"": <div className="col-lg-4">
