...
const Uploadclientform = () => {
    ...
    const submitclientform = () => {
        ...
        if(userType == 3){
            ...
            if (clientSelected.current.value == "" || clientSelected.current.value == "Choose a client" || client_id == "" || formname.current.value == "" || !formFile.current.files[0]) {
            ...
            if (client_id == "" || formname.current.value == "" || !formFile.current.files[0] || clientSelected.current.value == "" || clientSelected.current.value == "Choose a client" || trainerSelected.current.value == "") {
                        ...
                        <Modal isOpen={successModal} toggle={successToggleModal} className="connect-box" centered={true}>
                            ...
                            <ModalBody>
                                <div className="modal-p">
                                    <p>Client form has been uploaded Successfully</p>
                                </div>
                            </ModalBody>
