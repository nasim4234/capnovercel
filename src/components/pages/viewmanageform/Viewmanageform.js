        ...
        <div>
            ...
            <div className="wrp-dashbord">
                ...
                <div className="right-section">
                    <Filter />
                    {
                        !userType?"":<><div className="create-section">
                        <ul className="create-list">
                            <li>
                                <div className="create-list-box"><Link to="/blank-forms">{t('Download-Fill-in-PDF-Blank-Forms')}</Link></div>
                            </li>
                            <br />
                            <li>
                            ...
                            {
                                userType != 3 ? <li>
                                    <div className="create-list-box"><Link to={(selectedClient === "" || selectedClient === "Choose a Client") ? "" : "/upload/trainer/form"} className={(selectedClient === "" || selectedClient === "Choose a Client") ? "deactivate" : ""}>{t('Upload-Completed-Trainer-Forms')}</Link></div>
                                </li> : ""
                            }


                            {
                                userType && userType != 3 ? <li>
                                    ...
                                    <li>
                                        <div className="create-list-box"><Link to={selectedSession === "" || selectedSession === "null" ? "" : "/view/uploaded/trainer/form"} className={selectedSession === "" || selectedSession === "null" ? "deactivate" : ""}>{t('View-Completed-Trainer-Forms')}</Link></div>
                                    </li>
                            }
                            <br />
                            ...
                            {
                                userType == 2?"":<li>
                                <div className="create-list-box" onClick={() => setHomework()}><Link to={(selectedHomework === "false" || selectedSession === "" || selectedSession === "null") ? "" : "/upload/homework/asignment"} className={(selectedHomework === "false" || selectedSession === "" || selectedSession === "null") ? "deactivate" : ""}>{t('Upload-Homework-Assignment')}</Link></div>
                            </li>
                            }
                            <li>
