            ...
            if (v.sessionid == md5(selectedSession) || selectedSession == "null" ){
                        ...
                        _temp.push({
                            ...
                            action: <p> <Tooltip classes={{
                              ...
                              }} title="Download" placement="top"><a href="javascript:void(0)" className="downloadimg" onClick={()=> onButtonClick(FORM_URL+'/homework/'+v.file)} ><img src={download} /></a></Tooltip> <Tooltip classes={{
                                tooltip: classes.customTooltip,
                                
                              }} title="View" placement="top"><a href="javascript:void(0)" className="downloadimg" onClick={()=> onButtonClickopen(FORM_URL+'/homework/'+v.file)}><img src={preveiw} /></a></Tooltip> <Tooltip classes={{
                                tooltip: classes.customTooltip,
            ...
            <div className="wrp-dashbord">
                ...
                <div className="right-section">
                    <div className="configer-head">
                        ...
                        <div className="configer-child1"><h3>View Completed Client Homework</h3></div>
                    </div>
                    <div className="filter-mrb">
                        ...
                        {
                            userType == 2 || userType == 3?"":<div className="col-lg-3">
                    ...
                    {
                        userType == 3?"":<div className="col-lg-3">
                        <div className="trainerbox">
