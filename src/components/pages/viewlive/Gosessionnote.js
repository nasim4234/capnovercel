...
import Filter2 from "../../component/Gofilter";
    ...
    return (
        <div>
                    ...
                    <div className="create-section">
                        <ul className="create-list groupreport-list sessionreportnoteslist">
                            <li>
                                <div className="create-list-box"><a href="javascript:void" className={(sessionsNotes.length == 0 || selectedSession === "" ||selectedSession === "null") ? "deactivate" : ""} onClick={() => { Viewlivesessionnotes(); openToggleModal() }}>{t('View-Live-Session-Notes')}</a></div>
                            </li>
                            <li>
                                <div className="create-list-box"><a href="javascript:void" className={(sessionsNotes.length == 0 || selectedSession === "" ||selectedSession === "null") ? "deactivate" : ""} onClick={() => { downloadlivesessionnotes(); DownloaderToggleModal() }}>{t('Download-Live-Session-Notes')}</a></div>
                            </li>
                        
                            <li>
                                <div className="create-list-box"><a href="javascript:void" className={(sessionsAudio.length == 0 || selectedSession === "" ||selectedSession === "null") ? "deactivate" : ""} onClick={(sessionsAudio.length == 0 || selectedSession === "" ||selectedSession === "null") ? "" : DownloadlivesessionAudionote}>Listen/Download Live Session Audio Notes</a></div>
                            </li>
