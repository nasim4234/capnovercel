                ...
                <div className="right-section">
                    ...
                    <div className="create-section">
                        <ul className="create-list">
                            <li>
                                <div className="create-list-box"><a href="javascript:void" className={(sessionsNotes.length == 0 || selectedSession === "" ||selectedSession === "null") ? "deactivate" : ""} onClick={() => { (sessionsNotes.length == 0 || selectedSession === "" ||selectedSession === "null") ?"" : Viewlivesessionnotes()}}>{t('View-Live-Session-Notes')}</a></div>
                            </li>
                            <li>
                                <div className="create-list-box"><a href="javascript:void" className={(sessionsNotes.length == 0 || selectedSession === "" ||selectedSession === "null") ? "deactivate" : ""} onClick={() => { (sessionsNotes.length == 0 || selectedSession === "" ||selectedSession === "null") ?"": downloadlivesessionnotes() }}>{t('Download-Live-Session-Notes')}</a></div>
                            </li>
                            <li>
                                <div className="create-list-box"><a href="javascript:void" className={(sessionsImages.length == 0 || selectedSession === "" ||selectedSession === "null") ? "deactivate" : ""} onClick={() => {(sessionsImages.length == 0 || selectedSession === "" ||selectedSession === "null") ?"": ViewlivesessionImage() }}>{t('View-Live-Session-Images')}</a></div>
                            </li>
                            <li>
                                <div className="create-list-box"><a href="javascript:void" className={(sessionsImages.length == 0 || selectedSession === "" ||selectedSession === "null") ? "deactivate" : ""}  onClick={() => {(sessionsImages.length == 0 || selectedSession === "" ||selectedSession === "null") ?"": downloadlivesessionImage()}}>{t('Download-Live-Session-Images')}</a></div>
                            </li>

                        {
                            userType == 3 || userType ==2?"":<li>
                            <div className="create-list-box"><a href="javascript:void" className={(sessionsAudio.length == 0 || selectedSession === "" ||selectedSession === "null") ? "deactivate" : ""} onClick={(sessionsAudio.length == 0 || selectedSession === "" ||selectedSession === "null") ? "" : DownloadlivesessionAudionote}>View/Download Live Session Audio Notes</a></div>
                        </li>
                        }
                            ...
                            <li>
                                <div className="create-list-box create-list-boxzoomlink" >
                                    <a href="javascript:void" className={(selectedSession === "" ||selectedSession === "null") ? "deactivate" : ""}>
                                        ...
                                        {
                                            (zoomdata.length > 0) ?
                                                <a href="javascript:void" data-toggle="modal" onClick={ ()=> {(selectedSession === "" ||selectedSession === "null") ?"": zoomlinkupdatecontenttoggleModal() }}  >{t('View/Link-Zoom-Recordings')}</a>
                                                :
                                                <a href="javascript:void" data-toggle="modal" onClick={()=> {(selectedSession === "" ||selectedSession === "null") ?"": zoomlinkcontenttoggleModal() }}  >{t('View/Link-Zoom-Recordings')}</a>
