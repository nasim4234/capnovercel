               ...
               <div className="right-section2">
                    <div className="client-info-c">
                        ...
                        <div className="back-icon-wrp">
                            <Link to="/go/list/client" className="backbtn-icon">
                    ...
                    <div className="client-info-box">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6">
                                    <div className="client-input">
                                        <p>Telephone *</p>
                                        <input type="number" placeholder="Enter a telephone" defaultValue={client.telephone} ref={telephone} />
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <div className="go-back">
                                        <Link to="/go/list/client">Go Back</Link>
                                    </div>
                                </div>
                                <div className="col-lg-6">
...
export default Goclientinformation;