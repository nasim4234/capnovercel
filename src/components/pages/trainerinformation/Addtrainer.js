...
const Addtrainer = () => {
    ...
    const createtrainers = () => {
        ...
        if (validator.trim(firstname.current.value) == "" || validator.trim(lastname.current.value) == "" || email.current.value == "") {
            ...
            <div className="wrp-dashbord">
                ...
                <div className="right-section">
                    <div className="client-info-c">
                        ...
                        <div className="client-info-c-head"><h3>Add Trainer Information</h3></div>
                    </div>
                    <div className="client-info-box">
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6">
                                <div className="client-input">
                                    <p>Password</p>
                                    <input type={passwordShown ? "text" : "password"} placeholder="Enter password" ref={password} />
                                    {
