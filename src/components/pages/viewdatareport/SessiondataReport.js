                ...
                <div className="right-section">
                    <div className="view-session-reportdata">
                        ...
                        <div className="view-session-reportHeading">
                            ...
                            <h3 className="heading-mobile">{type == "multi" ? t("Multi Session Data Report") : type == "single" ? t("Single Session Data Report") : type == "group" ? t("Group Session Data Report") : type == "homework" ? t("Client Homework Report") : null} </h3>
                        </div>
                    </div>
                    <div className="wrp-bankform">
                        <div style={{ maxWidth: '100%' }}>
                            <MaterialTable
                                columns={columns}
                                data={data}
                                title={type == "multi" ? t("Multi Session Data Report") : type == "single" ? t("Single Session Data Report") : type == "group" ? t("Group Session Data Report") : type == "homework" ? t("Client Homework Data Report") : null}
                                options={{
                                    pageSize: 15,
