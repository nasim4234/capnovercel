...
const Editprofile = () => {
    ...
    const profileSave = () => {
        ...
        if (validator.trim(firstname.current.value) == "" || validator.trim(lastname.current.value) == "" || validator.trim(email.current.value) == "" || validator.trim(password.current.value) == "") {
